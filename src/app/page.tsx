    ...
    <>
      <ClientRemount>
        ...
        <div className="absolute top-4 left-4 z-50 mt-10">
          ...
          >
            <Star
              className="fill-yellow-400 text-yellow-600 group-hover:scale-110 transition-transform duration-200 drop-shadow"
              size={20}
            />
            <span className="flex items-center gap-1 text-xs sm:text-sm">
              {stars !== null ? (
                <>
                  ...
                  <span className="ml-2 text-yellow-700/90 group-hover:text-yellow-900 transition-colors">
        ...
        <div
          ...
          style={{
            backgroundImage: "linear-gradient(to top left, #000, rgba(82,82,82,0.12), #000)",
          }}
        >
          ...
          <Particles className="absolute inset-0 -z-10 animate-fade-in" quantity={85} />
          ...
          >
            <ArrowDownCircle
              size={32}
              className="text-zinc-400 hover:text-zinc-200 transition-all duration-200"
            />
        ...
        {/* ABOUT + TIMELINE: stack guaranteed */}
        <div id="about-me" className="w-screen relative z-10 py-24">
